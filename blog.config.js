...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'wanderer', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'A normal man', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://wandererwish.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'WandererWish', // 网站关键词 英文逗号隔开
